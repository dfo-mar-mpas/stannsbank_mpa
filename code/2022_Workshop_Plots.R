...
sab <- read_sf("r:/Science/CESD/HES_MPAGroup/Data/Shapefiles/StAnnsBank/SAB_boundary_zones_2017.shp")%>%
...
sab_bathy <- raster("M:/OCMD/02_Projects/MPA/St_Anns_Bank/Multibeam/CompositeLayers/bathy50/w001001.adf", RAT=FALSE)%>%
...
#load bathymetry 
ras <- raster("r:/Science/CESD/HES_MPAGroup/Projects/eDNA Genome Quebec/data/sab_dem.tif")
...
stars_dem <- ras%>%projectRaster(.,crs=latlong)%>%st_as_stars()
